			...
			<form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post" id="create-account_form" class="box">
				...
				<div class="form_content clearfix">
					...
					<div class="submit">
						...
						<p>
						<a href="{$link->getModuleLink('sociallogin','authenticate',["action"=>"google","mode" => "request"])|escape:'html':'UTF-8'}" class="button btn btn-outline button-medium">
							<span>
								<i class="fa fa-google-plus-square" aria-hidden="true"></i>
								{l s='Signup with Google'}
							</span>
						</a>
						</p>
						{/if}
						...
						<p>
						<a href="{$link->getModuleLink('sociallogin','authenticate',["action"=>"facebook","mode" => "request"])|escape:'html':'UTF-8'}" class="button btn btn-outline button-medium">
							<span>
								<i class="fa fa-facebook-official" aria-hidden="true"></i>
								{l s='Signup with Facebook'}
							</span>
						</a>
						</p>
						{/if}
