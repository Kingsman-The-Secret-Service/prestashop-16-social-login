...
class Sociallogin extends Module
{
    ...
    */
    ...
    public function hookDisplayTop($params)
    {
        ...
        return $this->display( dirname(__FILE__) , '/views/templates/front/blockuserinfo.tpl');
    }
    ...
    public function hookDisplayOverrideTemplate($params)
    {
        ...
        $tpl = dirname(__FILE__) . '/views/templates/front/authentication.tpl';
        if ($controllerName == 'AuthController' && file_exists($tpl)) 
            return $tpl;
        return false;
    }
}
