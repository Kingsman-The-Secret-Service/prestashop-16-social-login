...
class SocialloginAuthenticateModuleFrontController extends ModuleFrontController
{
    /**
    ...
    public function postProcess()
    {
        ...
        $redirectUrl = $this->context->link->getModuleLink('sociallogin','authenticate',array('action' => $action, 'mode' => 'response'));
